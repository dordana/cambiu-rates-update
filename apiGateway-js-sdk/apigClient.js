 ...
 */
require('./apiGateway-js-sdk/index.js');
...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.countriesGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
    ...
    apigClient.countriesOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var countriesOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/countries').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(countriesOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.ratesGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['city', 'base', 'type', 'country'], ['body']);
        
        var ratesGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/rates').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['city', 'base', 'type', 'country']),
            body: body
        };
